...
df = pd.read_csv("../../cumulative_results_moreseeds.csv")
...
print(df.columns)
print(df.dtypes)
group_cols = ["periodA", "nodesA", "periodB", "nodesB", "pktsizeB", "dataMode"]
...
df_agg.to_csv("../../aggregate_results_more_seeds.csv")