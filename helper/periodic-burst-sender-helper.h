...
#ifndef PERIODIC_BURST_SENDER_HELPER_H
#define PERIODIC_BURST_SENDER_HELPER_H
 ...
 * range of nodes.
 */
class PeriodicBurstSenderHelper
{
  public:
    PeriodicBurstSenderHelper();  //!< Default constructor
    ~PeriodicBurstSenderHelper(); //!< Destructor
    ...
    /**
     * Set the dwell time to space packets within a burst.
     *
     * @param duration The dwell time to set.
     */
  ...
  private:
    ...
    Ptr<UniformRandomVariable>
        m_intervalProb; //!< The random variable used to pick inter-burst intervals of
    ...
    uint16_t m_pktSize; //!< The base packet size.
    Time m_dwellTime;  //!< The interpacket spacing within a burst
};

} // namespace lorawan
} // namespace ns3

#endif /* PERIODIC_BURST_SENDER_HELPER_H */
